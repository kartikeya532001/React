    ...
    return (
        <>
            ...
            <div className='Main'>
                <div className='dis'>
                    <div className='img'>
                        <img src='/img/7.jpeg' alt='pic1' className='img1' />
                    </div>
                    <div className='image'>
                        <img src='/img/5.jpeg' alt='pic1' className='img2' />
                        <div className='image2'>
                            <img src='/img/6.jpeg' alt='pic1' className='img2' />
                        </div>
                        ...
                        <div>
                            <div className='hcards1'>
                                <div className='hcard1'>
                                    <h1 > Prices </h1>
                                    <p>
                                        <br /> Triple Sharing Room with Common Washroom: 1,40,000/- <br />
                                        <br /> Triple Sharing Room with Attached Washroom: 1,50,000/- <br />
                                        <br /> Triple Sharing AC Room with Attached Washroom: 1,60,000/-<br />
                                    </p>
                ...
                <div className='policies'>
                    <h1> YouthGems </h1>
                    <h3>Ponda,Dehradun,Uttarakhand 248001</h3>
                    <p> Rating: ⭐⭐⭐</p>
                </div>
