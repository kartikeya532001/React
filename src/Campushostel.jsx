    ...
    return (
        <>
            ...
            <div className='Main'>
                <div className='dis'>
                    <div className='img'>
                        <img src='/img/UPES1.jpg' alt='pic1' className='img1' />
                    </div>
                    <div className='image'>
                        <img src='/img/UPES3.jpg' alt='pic1' className='img2' />
                        <div className='image2'>
                            <img src='/img/1.jpeg' alt='pic1' className='img2' />
                        </div>
                    ...
                    <div className='prices'>
                        <div>
                                ...
                                <div className='hcard1'>
                                    <h1> Prices </h1>
                                    <p>
                                        <br /> Triple Sharing Room with <br/> Common Washroom: 1,80,000/- <br />
                                        <br /> Triple Sharing Room with <br/> Attached Washroom: 1,90,000/- <br />
                                        <br /> Triple Sharing AC Room with <br/> Attached Washroom: 2,10,000/-<br />
                                    </p>
                ...
                <div className='policies'>
                    <h1> Campushostel </h1>
                    <h3> Campus hostel, Bidholi Campus,Dehradun,Uttarakhand 248001</h3>
                    <p> Rating: ⭐⭐⭐</p>
                </div>
